    ...
    async def supervise(
        ...
        payload = await self._request(
            (
                ...
                "missing_evidence empty when source, tests, or project test configuration must "
                "change. A missing_evidence category means no passed evidence of that category "
                "was supplied; do not list test or browser when passed evidence of that kind is "
                "present merely because you prefer broader coverage. Treat a successful configured "
                "test command as valid behavioral evidence, including assertions about generated "
