...
- This was a rapid container-layer update only. Published GHCR/ACR image digests were deliberately not changed; recreating the controller from the current `0.1.0-alpha` image removes this UI increment until the next formal image release.
